package com.alkrist.maribel.client.render.filter.ssao;
...
public class SSAO {
	...
	public void render(Texture worldPos, Texture normal) {
		...
		ssaoShader.updateUniforms(Context.getCamera().getViewMatrix(),
				Context.getCamera().getProjectionMatrix(), width, height, kernel);
