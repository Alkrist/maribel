...
public abstract class ShaderBase {
	 ...
	 * Takes two shader file names WITHOUT extension and WITHOUT full path, just names.
	 * 
	 * Shaders must be stored in src/main/resources/assets/shaders folder and mush have .glsl extension!
	 * 
	...
	//UNIFORM LOCATIONS & LOADING------------------------------------------------------------------
		...
		//load a boolean value as float to the location (GLSL ain't have a boolean type)
		...
		//remove the shaders created and the program created -- used in the end to release memory
		public void cleanUp() {		
			stop();
		...
		//bind the attributes -- will use the bindAttribute method in the inherited classes
