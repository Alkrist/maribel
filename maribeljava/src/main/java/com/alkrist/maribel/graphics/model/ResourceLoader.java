...
public class ResourceLoader {
	...
	/**
	 * Create {@link Mesh} object without tangents.
	 * 
	 * @param vertices      - vertices of the mesh
	 * @param textureCoords - texture coordinates of the mesh
	 * @param normals       - normals of the mesh faces
	 * @param indices       - indices of vertex order
	 * @return new mesh
	 */
	...
	public static Mesh loadToVAO(float[] vertices, float[] textureCoords, float[] normals, int[] indices, float boundingRadius) {
		int vaoID = createVAO();
	...
	/**
	 * Create {@link Mesh} object.
	 * 
	 * @param vertices      - vertices of the mesh
	 * @param textureCoords - texture coordinates of the mesh
	 * @param normals       - normals of the mesh faces
	 * @param tangents      - tangents of the mesh faces
	 * @param indices       - indices of vertex order
	 * @return new mesh
	 */
	public static Mesh loadToVAO(float[] vertices, float[] textureCoords, float[] normals, float[] tangents,
			int[] indices) {
		int vaoID = createVAO();
	...
	public static Mesh loadToVAO(float[] vertices, float[] textureCoords, float[] normals, float[] tangents,
			int[] indices, float boundingRadius) {
		int vaoID = createVAO();
	...
	/**
	 * Create {@link Mesh} object with vertices only.
	 * 
	 * @param positions  - vertices of the mesh
	 * @param dimensions - defines the vertex coordinate system (2 for 2D, 3 for 3D)
	 * @return new mesh
	 */
