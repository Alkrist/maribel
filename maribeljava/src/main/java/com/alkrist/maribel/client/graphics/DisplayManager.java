...
public class DisplayManager {
	...
	public void createWindow(String title) {
		...
		window = GLFW.glfwCreateWindow(WIDTH, 
				HEIGHT, 
				title, 
				Settings.CURRENT.fullscreen ? GLFW.glfwGetPrimaryMonitor() : 0, 
						0);
	...
	/**
	 * If enable requested and settings are set to false - enable;
	 * if settings already true - ignore
	 * 
	 * If disable requested and settings are set to true - disable;
	 * if settings already false - ignore
	 * 
