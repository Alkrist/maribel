...
public class SoundSource {
	  ...
	  * OpenAL Sound Source
	  * 
	  * @param loop - indicates if the sound to be played should be in loop mode
	  * @param relative - controls if the position of the source is relative to the listener
	  */
