package com.alkrist.maribel.client.render.texture;
...
public static ImageMeta loadImage(String file, int id) {
        ...
        ImageMeta metaData = new ImageMeta(width,height,comp);
